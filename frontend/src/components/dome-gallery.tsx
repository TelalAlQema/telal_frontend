...
export function DomeGallery({
  ...
  const openItemFromElement = (el: HTMLElement) => {
    ...
    let rotY = (-(parentY + globalY) % 360) % 360;
  ...
  const onTileClick = (e: React.MouseEvent<HTMLDivElement>) => {
          ...
          <div ref={sphereRef} className="sphere">
            {items.map((it, i) => (
              ...
              >
                ...
                >
                  {/* eslint-disable-next-line @next/next/no-img-element -- gallery clones this DOM node for the enlarge animation, so a plain img is required */}
